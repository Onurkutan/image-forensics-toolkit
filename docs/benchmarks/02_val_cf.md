...
|---|---|---|---|---|---|---|---|---|---|
| dinov2_head | fixed | 1.000 | 1.000 | 0.998 | 0.997 | 0.000 | 0.995 | 0.009 | 0.002 |
| dinov2_head | tuned | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 | 1.000 | 0.009 | 0.002 |

## Robustness (AUC / balanced accuracy at the fixed threshold)

| detector | level | auc | balanced_accuracy |
|---|---|---|---|
| dinov2_head | clean | 1.000 | 0.997 |
